...
def event_detail(event_id):
    ...
    return render_template('event_detail.html', event=single_event, date=date, time=time)
...
def rsvp(event_id):
    ...
    if is_returning_guest:
        # Look up the guest by name, and add the event to their events_attending, then commit to the database
